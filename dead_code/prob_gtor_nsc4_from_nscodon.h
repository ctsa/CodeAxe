...
/// \file prob_gtor_nsc4_from_nscodon.h
/// \brief
///

#ifndef __PROB_GTOR_NSC4_FROM_NSCODON_H
#define __PROB_GTOR_NSC4_FROM_NSCODON_H
...
struct prob_gtor_nsc4_from_nscodon : public prob_gtor<FLOAT_T> {

  typedef prob_gtor<FLOAT_T> base_t;
  typedef prob_gtor_nsc4_from_nscodon<FLOAT_T> self_t;

  prob_gtor_nsc4_from_nscodon() : base_t(NSC4::SIZE,PARAM_SIZE) {}
...
private:
  ...
  void set_param_state_internal(const FLOAT_T* x) {
    ...
    nscodon_pdf_2_nsc4_pdf(x2,this->distro());
  }
